...
| | |
| :--- | :--- |
| **Release** | [🔗 nightly-20260822-122643](https://github.com/The412Banner/Nightlies/releases/tag/nightly-20260822-122643) |
...
| **D7VK (DDraw/D3D7)** | [`898c730ec`](https://github.com/WinterSnowfall/d7vk/commit/898c730ec) — DDraw Wrapper slot; `.tzst` = bundled-asset refresh |
...
| **Files** | [`.wcp` and `.zip` — scroll to Assets](https://github.com/The412Banner/Nightlies/releases/tag/nightly-20260822-122643) |
<!-- NIGHTLY-LATEST-END -->
